...
describe('API Workflow', () => {
  ...
  it('should receive not be allowed to access private data without a token', async () => {
  ...
  it('should receive be allowed to access private data with a valid token', async () => {
    const request = await fetch(`${BASE_URL}/`, {
      method: 'GET',
      headers: {
